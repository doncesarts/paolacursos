...
<spring:url value="/resources/css/EstilosAdministrador.css" var="mainCss" />
...
$(window).bind('resize orientationchange', function() {
	...
	ww = document.body.clientWidth;
		if (ww > 768) {
	$("#menu").show();
	$("ul li ul").css("position","absolute");
	
}
	
if (ww < 768) {
	/*importante para que al estar en posicion chica los elementos se recorran que 
	estan abajo*/
	$("ul li ul").css("position","relative");
...
<div id="left"></div>
<div id="inner-div2" class="row"></div>
<div id="right"></div>
</div>
</div>
